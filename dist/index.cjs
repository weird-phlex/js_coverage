...
__export(main_exports, {
  ...
  addLineCoverage: () => addLineCoverage,
  simpleCovCoverage: () => simpleCovCoverage
});
...
var init_main = __esm({
  "src/main.js"() {
    ({ FileCoverage } = require_file_coverage());
...
// src/index.cjs
var { addLineCoverage: addLineCoverage2, simpleCovCoverage: simpleCovCoverage2 } = (init_main(), __toCommonJS(main_exports));
module.exports = {
  addLineCoverage: addLineCoverage2,
  simpleCovCoverage: simpleCovCoverage2
};
